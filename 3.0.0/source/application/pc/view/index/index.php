...
<div class="banner">
    <div class="swiper-container swiper-container-banner-pc ">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <a href="#"><img src="assets/pc/images/banner.jpg" width="100%"></a>
            </div>
            <div class="swiper-slide">
                <a href="#"><img src="assets/pc/images/banner.jpg" width="100%"></a>
            </div>
    ...
    <div class="swiper-container swiper-container-banner-h5">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <a href="#"><img src="assets/pc/images/h5banner.jpg" width="100%"></a>
            </div>
            <div class="swiper-slide">
                <a href="#"><img src="assets/pc/images/h5banner.jpg" width="100%"></a>
            </div>
...
<div class="main">
    ...
    <div class="about">
        <div class="about-b">
            ...
            <div class="about-company">佛山朴真茶业有限公司</div>
            <div class="clearfix"></div>
            <div class="about-des">朴真秉持朴实真诚的原则，坚持制作好用且真材实料的产品，专注与通过科技为饮茶人化繁为简，提供轻松愉悦的用茶环境。</div>
