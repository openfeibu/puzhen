...
class User extends FactoryUserModel
{
    ...
    public function add($data)
    {
        ...
        try {
            ...
            // 新增角色关系记录
            (new UserRole)->add($this['factory_user_id'], $data['role_id']);
            $this->commit();
            return true;
        } catch (\Exception $e) {
    ...
    public function edit($data)
    {
        ...
        try {
            ...
            $this->allowField(true)->save($data);
            // 更新角色关系记录
            (new UserRole)->edit($this['factory_user_id'], $data['role_id']);
            $this->commit();
            return true;
        } catch (\Exception $e) {
            $this->error = $e->getMessage();
    ...
    public function setDelete()
    {
        ...
        // 删除对应的角色关系
        UserRole::deleteAll(['factory_user_id' => $this['factory_user_id']]);
    ...
    public function renew($data)
    {
        ...
        // 更新session
        Session::set('fbshop_factory.user', [
            'factory_user_id' => $this['factory_user_id'],
            'user_name' => $data['user_name'],
        ]);
        return true;
    }
