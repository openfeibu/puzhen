...
namespace app\factory\service\goods;
...
class Import
{
     ...
     */
    public $title_arr = [
        'category_name' => '产品分类','goods_name' => '产品名称','selling_point' => '产品卖点','goods_no' => "产品编码",'ref_price' => "参考零售价",'goods_weight' => '产品重量(g)'
    ];
    ...
    public function goodsList($factory_id)
    {
