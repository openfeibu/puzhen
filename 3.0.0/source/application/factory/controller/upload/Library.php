...
namespace app\factory\controller\upload;

use app\factory\controller\Controller;
use app\factory\model\UploadFile as UploadFileModel;
use app\factory\model\UploadGroup as UploadGroupModel;
...
class Library extends Controller
{
    ...
    public function fileList($type = 'image', $group_id = -1)
    {
        ...
        // 文件列表
        $file_list = (new UploadFileModel)->getlist(intval($group_id), $type, 0);
