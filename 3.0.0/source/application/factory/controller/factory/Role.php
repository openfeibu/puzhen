...
use app\factory\model\factory\Access as AccessModel;
...
class Role extends Controller
{
    ...
    public function add()
    {
        ...
        if ($model->add($this->postData('role'))) {
            return $this->renderSuccess('添加成功', url('factory.role/index'));
        }
    ...
    public function edit($role_id)
    {
        ...
        if ($model->edit($this->postData('role'))) {
            return $this->renderSuccess('更新成功', url('factory.role/index'));
        }
