<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:99:"E:\UPUPW_ANK_W64\WebRoot\Vhosts\puzhen\2.0.0\web/../source/application/factory\view\goods\index.php";i:1655807739;s:95:"E:\UPUPW_ANK_W64\WebRoot\Vhosts\puzhen\2.0.0\source\application\factory\view\layouts\layout.php";i:1653035871;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <form class="toolbar-form" action="">
                            ...
                            <div class="am-u-sm-12 am-u-md-3">
                                <div class="am-form-group">
                                    ...
                                    <?php endif; if (checkPrivilege('goods/import')): ?>
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a class="am-btn am-btn-default am-btn-success"
                         ...
                         tpl-table-black am-text-nowrap">
                            ...
                            <?php if (!$list->isEmpty()): foreach ($list as $item): ?>
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <?php if (isset($item['goods_tea_qrcode']) && $item['goods_tea_qrcode']): if (checkPrivilege('tea_qrcode.factory_tea_qrcode/edit')): ?>
                                            ...
                                            <?php endif; if (checkPrivilege('goods/bind_tea_qrcode')): ?>
                                            <a class="am-btn am-btn-xs am-round am-btn-danger" href="<?= url('goods/bind_tea_qrcode',
                                                ['goods_id' => $item['goods_id']]) ?>">
                                                换绑
                                            </a>
                                            <?php endif; else: if (checkPrivilege('tea_qrcode.factory_tea_qrcode/add')): ?>
