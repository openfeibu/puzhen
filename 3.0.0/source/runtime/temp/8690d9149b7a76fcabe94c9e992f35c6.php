<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:108:"E:\UPUPW_ANK_W64\WebRoot\Vhosts\puzhen\2.0.0\web/../source/application/factory\view\data\tea_qrcode\list.php";i:1655783529;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                ...
                <td class="am-text-middle">
                    <label class="am-checkbox">
                        <input data-am-ucheck data-check="item" data-params='<?= json_encode([
                            'tea_qrcode_id' => (string)$item['tea_qrcode_id'],
                            'name' => $item['name'],
