<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:106:"E:\UPUPW_ANK_W64\WebRoot\Vhosts\puzhen\2.0.0\web/../source/application/factory\view\factory\role\index.php";i:1653035871;s:95:"E:\UPUPW_ANK_W64\WebRoot\Vhosts\puzhen\2.0.0\source\application\factory\view\layouts\layout.php";i:1653035871;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="widget-body am-fr">
                    ...
                    <div class="page_toolbar am-margin-bottom-xs am-cf">
                        <div class="am-form-group">
                            <?php if (checkPrivilege('factory.role/add')): ?>
                                <div class="am-btn-group am-btn-group-xs">
                                    <a class="am-btn am-btn-default am-btn-success"
                                       href="<?= url('factory.role/add') ?>">
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (checkPrivilege('factory.role/edit')): ?>
                                                <a href="<?= url('factory.role/edit', ['role_id' => $item['role_id']]) ?>">
                                                    <i class="am-icon-pencil"></i> 编辑
                                                </a>
                                            <?php endif; if (checkPrivilege('factory.role/delete')): ?>
                                                <a href="javascript:void(0);"
...
<script>
    $(function () {
        ...
        // 删除元素
        var url = "<?= url('factory.role/delete') ?>";
