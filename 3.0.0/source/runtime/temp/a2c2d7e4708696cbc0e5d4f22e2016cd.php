<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:97:"E:\UPUPW_ANK_W64\WebRoot\Vhosts\puzhen\2.0.0\web/../source/application/store\view\factory\add.php";i:1652864460;s:93:"E:\UPUPW_ANK_W64\WebRoot\Vhosts\puzhen\2.0.0\source\application\store\view\layouts\layout.php";i:1647313182;s:109:"E:\UPUPW_ANK_W64\WebRoot\Vhosts\puzhen\2.0.0\source\application\store\view\layouts\_template\file_library.php";i:1647313182;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">添加工厂</div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="factory[phone]"
                                           placeholder="请输入工厂联系电话" required>
                                </div>
                            </div>
