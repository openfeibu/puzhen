<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:100:"E:\UPUPW_ANK_W64\WebRoot\Vhosts\puzhen\2.0.0\web/../source/application/store\view\passport\login.php";i:1656065577;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <meta content="IE=edge" http-equiv="X-UA-Compatible">
    <title>泡臣服务系统登录</title>
    ...
    <div id="wrapper" class="login-body">
        <div class="login-content">
            <div class="brand">
                ...
                <h2 class="brand-text">泡臣服务管理系统</h2>
            </div>
