<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:98:"E:\UPUPW_ANK_W64\WebRoot\Vhosts\puzhen\2.0.0\web/../source/application/store\view\factory\edit.php";i:1654657141;s:93:"E:\UPUPW_ANK_W64\WebRoot\Vhosts\puzhen\2.0.0\source\application\store\view\layouts\layout.php";i:1655712011;s:109:"E:\UPUPW_ANK_W64\WebRoot\Vhosts\puzhen\2.0.0\source\application\store\view\layouts\_template\file_library.php";i:1647313182;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">编辑工厂</div>
                            </div>
                            ...
                            <div class="am-form-group am-padding-top">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="factory[linkman]"
                                           placeholder="请输入工厂联系人" value="<?= $model['linkman'] ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="factory[phone]"
                                           placeholder="请输入工厂联系电话" value="<?= $model['phone'] ?>" required>
                                </div>
                            </div>

                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">工厂排序 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="factory[sort]"
                                           value="<?= $model['sort'] ?>" required>
                                    <small>数字越小越靠前</small>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require"> 工厂状态 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="factory[status]" value="1" data-am-ucheck
                                            <?= $model['status'] == 1 ? 'checked' : '' ?>>
                                        启用
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="factory[status]" value="0" data-am-ucheck
