<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:98:"E:\UPUPW_ANK_W64\WebRoot\Vhosts\puzhen\2.0.0\web/../source/application/store\view\order\detail.php";i:1647313182;s:93:"E:\UPUPW_ANK_W64\WebRoot\Vhosts\puzhen\2.0.0\source\application\store\view\layouts\layout.php";i:1647313182;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                <div class="widget__order-detail widget-body am-margin-bottom-lg">
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <div class="td__order-price am-text-left">
                                        ...
                                        <?php endif; if ($detail['points_num'] > 0) : ?>
                                            <ul class="am-avg-sm-2">
                    ...
                    <!-- 自提门店信息 -->
                    <?php if ($detail['delivery_type']['value'] == DeliveryTypeEnum::EXTRACT): if (!empty($detail['extract'])): ?>
                            <div class="widget-head am-cf">
                    ...
                    <!--  用户取消订单 -->
                    <?php if ($detail['pay_status']['value'] == 20 && $detail['order_status']['value'] == 21): if (checkPrivilege('order.operate/confirmcancel')): ?>
                            <div class="widget-head am-cf">
                    ...
                    <?php if (
                        ...
                        <?php if ($detail['delivery_status']['value'] == 10): if (checkPrivilege('order/delivery')): ?>
                                <!-- 去发货 -->
                    ...
                    <?php if (
                        ...
                        <?php if ($detail['delivery_status']['value'] == 10): if (checkPrivilege('order.operate/extract')): ?>
                                <form id="delivery" class="my-form am-form tpl-form-line-form" method="post"
