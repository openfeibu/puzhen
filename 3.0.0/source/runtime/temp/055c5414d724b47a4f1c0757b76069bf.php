<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:99:"E:\UPUPW_ANK_W64\WebRoot\Vhosts\puzhen\2.0.0\web/../source/application/store\view\shop\getpoint.php";i:1647313183;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript">
    ...
    $(".search_t").autocomplete({
        source: function (request, response) {
            url4 = encodeURI("https://apis.map.qq.com/ws/place/v1/suggestion/?keyword=" + request.term + "&region=" + curCity.children[0].innerHTML + "&key=ZWEBZ-R7N3U-BJSVH-4TCR3-66MDQ-S3FDJ&output=jsonp&&callback=?");
