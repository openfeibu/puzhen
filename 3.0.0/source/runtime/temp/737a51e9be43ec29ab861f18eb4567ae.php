<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:105:"E:\UPUPW_ANK_W64\WebRoot\Vhosts\puzhen\2.0.0\web/../source/application/store\view\data\equipment\list.php";i:1655783346;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                ...
                <td class="am-text-middle">
                    <label class="am-checkbox">
                        <input data-am-ucheck data-check="item" data-params='<?= json_encode([
                            ...
                            'model' => $item['model'],
                            'equipment_image' => $item['image']['file_path'],
