<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:99:"E:\UPUPW_ANK_W64\WebRoot\Vhosts\puzhen\2.0.0\web/../source/application/store\view\setting\trade.php";i:1647313183;s:93:"E:\UPUPW_ANK_W64\WebRoot\Vhosts\puzhen\2.0.0\source\application\store\view\layouts\layout.php";i:1647313182;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <form id="my-form" class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post">
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-form-label form-require">运费组合策略 </label>
                                <div class="am-u-sm-9">
