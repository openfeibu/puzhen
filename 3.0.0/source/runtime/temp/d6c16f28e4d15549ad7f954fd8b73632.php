<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:116:"E:\UPUPW_ANK_W64\WebRoot\Vhosts\puzhen\2.0.0\web/../source/application/store\view\equipment\user_equipment\index.php";i:1655879711;s:93:"E:\UPUPW_ANK_W64\WebRoot\Vhosts\puzhen\2.0.0\source\application\store\view\layouts\layout.php";i:1655712011;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <form class="toolbar-form" action="">
                            ...
                            <div class="am-u-sm-12 am-u-md-3">
                                <div class="am-form-group">
                                    ...
                                    <?php endif; if ($status == 20): if (checkPrivilege('equipment.user_equipment/export')): ?>
                                        <div class="am-btn-group am-btn-group-xs">
                                    ...
                                    <?php endif; endif; if ($status == 30): if (checkPrivilege('equipment.user_equipment/delete')): ?>
                                            <div class="am-btn-group am-btn-group-xs">
                            ...
                            <?php if (!$list->isEmpty()): foreach ($list as $item): ?>
                                <tr>
                                    <td class="am-text-middle">
                                        <label class="am-checkbox">
                                            <input data-am-ucheck data-check="item" data-id='<?= $item['user_equipment_id'] ?>' type="checkbox">
                                        </label>
                                    </td>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (checkPrivilege('equipment.user_equipment/edit')): if ($item['status']['value'] == 10): ?>
                                                    <a class="j-audit"
                                                ...
                                                <?php endif; endif; if (checkPrivilege('equipment.user_equipment/delete')): ?>
                                                <a href="javascript:void(0);"
...
<script>
    $(function () {
        ...
        $('.batch-delete').batch_delete('user_equipment_id', url, '删除后不可恢复，确定要删除吗？');
        /**
         * 订单导出
         */
