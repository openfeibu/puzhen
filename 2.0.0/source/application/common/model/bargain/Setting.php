        ...
        return [
            'basic' => [
                ...
                'values' => [
                    ...
                    'is_dealer' => '0',
                    // 砍价规则
                    'bargain_rules' => "活动期间，用户可以在砍价活动页选择活动产品发起砍价，可通过微信分享砍价产品活动页面给好友，并通过好友助力砍价，将产品砍至一定金额。\n\n" .
                        "每次砍价金额随机，可砍出最高产品日常价内的随机金额，参与好友越多越容易成功。\n\n" .
                        "以最终砍价后的优惠价格购买该产品，且用户须在活动时间结束之前进行支付购买，否则砍价产品价格将过期失效。\n\n" .
                        "产品库存有限，以前台展示的库存数量为准，先到先得。",
                ]
            ]
        ];
    }
