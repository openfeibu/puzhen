...
class Controller extends \think\Controller
{
    ...
    private function layout()
    {
        ...
        if (!in_array($this->routeUri, $this->notLayoutAction)) {
            ...
            $this->assign([
                ...
                'factory_url' => url('/factory'),              // 后台模块url
                'group' => $this->group,                       // 当前控制器分组
                'menus' => $this->menus(),                     // 后台菜单
                'factory' => $this->factory,                       // 商家登录信息
    ...
    private function checkLogin()
    {
        ...
        if (empty($this->factory)
            || (int)$this->factory['is_login'] !== 1
            || !isset($this->factory['wxapp'])
            || empty($this->factory['wxapp'])
        ) {
    ...
    {
        return $this->factory['wxapp']['wxapp_id'];
    }
