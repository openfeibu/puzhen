                ...
                <div class="widget-body am-fr">
                    <div class="tips am-margin-bottom-sm am-u-sm-12">
                        <div class="pre">
                            ...
                            <p> 3：商户后台菜单配置文件：source/application/factory/extra/menus.php</p>
                        </div>
                    </div>
                    <!-- 工具栏 -->
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <a href="<?= url('factory.access/edit', ['access_id' => $item['access_id']]) ?>">
