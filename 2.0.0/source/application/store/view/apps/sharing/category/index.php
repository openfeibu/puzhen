        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                <div class="widget-head am-cf">
                    <div class="widget-title am-cf">拼团产品分类</div>
                </div>
                                ...
                                <?php if (checkPrivilege('apps.sharing.category/add')): ?>
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a class="am-btn am-btn-default am-btn-success am-radius"
                                           href="<?= url('apps.sharing.category/add') ?>">
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (checkPrivilege('apps.sharing.category/edit')): ?>
                                                <a href="<?= url('apps.sharing.category/edit',
                                                    ['category_id' => $first['category_id']]) ?>">
                                                    <i class="am-icon-pencil"></i> 编辑
                                                </a>
                                            <?php endif; ?>
                                            <?php if (checkPrivilege('apps.sharing.category/delete')): ?>
...
<script>
    $(function () {
        // 删除元素
        var url = "<?= url('apps.sharing.category/delete') ?>";
